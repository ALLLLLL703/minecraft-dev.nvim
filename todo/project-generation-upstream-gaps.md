...
- [x] 动态 MC/Forge 兼容版本，限制 MC >= 1.16。
- [x] 按 1.16、1.17、1.18、1.19、1.19.3、1.20、1.20.6+ 选择入口模板。
- [x] MC 1.20.1+ 生成示例 `Config.java`，MC 1.21 使用新版模板。
- [x] 生成可编译的示例 Mixin 类，不只生成空配置。
- [x] 完整更新 URL、作者、网站和依赖元数据。
- [x] 许可证文件和版本对应的 `pack.mcmeta`。
- [x] `genIntellijRuns` 的 Neovim 等价运行任务。
