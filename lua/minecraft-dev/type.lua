...
---@field prompts { project: { group_id: string, artifact_id: string, main_class: string }, paper: { select_language: string, telescope_title: string }, fabric: { loom_version: string, select_language: string, select_side: string, generate_datagen: string, use_mixins: string, telescope_title: string } }
