...
M.cases = {
	...
	{
		name = "forge-1-16-5-java-gradle",
		toolchain = { jdk = 17, gradle = "8.8", target_jdk = 8 },
		spec = project_spec({
			platform = "forge",
			build_system = "gradle",
			...
			loader_version = "36.2.42",
			use_mixins = true,
		}),
	},
	{
		name = "forge-1-20-1-java-gradle",
		toolchain = { jdk = 17, gradle = "8.8" },
		spec = project_spec({
			platform = "forge",
			build_system = "gradle",
	...
	{
		name = "forge-1-20-6-java-gradle",
		toolchain = { jdk = 21, gradle = "8.8" },
		spec = project_spec({
			platform = "forge",
			build_system = "gradle",
	...
	{
		name = "neoforge-1-21-4-java-gradle",
		toolchain = { jdk = 21, gradle = "8.8" },
		spec = project_spec({
			platform = "neoforge",
			build_system = "gradle",
			...
			plugin_name = 'Matrix "Mod"',
			description = "First line\nSecond line",
			update_url = "https://example.invalid/updates/$channel.json",
			website = "https://example.invalid/${project}",
			use_mixins = true,
		}),
	},
	{
		name = "neoforge-1-20-6-kotlin-gradle",
		toolchain = { jdk = 21, gradle = "8.14", kotlin = "2.0.0" },
		spec = project_spec({
			platform = "neoforge",
			build_system = "gradle",
			minecraft_version = "1.20.6",
			...
			artifact_id = "matrixmod",
			package_name = "dev.minecraft.matrixmod",
			loader_version = "20.6.139",
			neogradle_version = "7.1.38",
			use_mixins = true,
		}),
	},
	{
